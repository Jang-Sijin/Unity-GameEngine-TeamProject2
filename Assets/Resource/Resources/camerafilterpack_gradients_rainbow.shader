			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c2, -0.649999976, -0.0399999991, -0.5, 0.150000006
					    def c3, -2, 1, 3, 5
					    def c4, 2.43902445, 0, 0, 0
					    def c5, 0.212599993, 0.715200007, 0.0722000003, 1.5
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    texld r0, v0, s0
					    dp3 r0.w, r0, c5
					    mad r1.x, r0.w, c3.x, c3.y
					    mad r0.w, c0.x, r1.x, r0.w
					    add r1.xyz, r0.w, c2
					    mul_sat r0.w, r1.y, c4.x
					    mad r1.w, r0.w, c3.x, c3.z
					    mul r0.w, r0.w, r0.w
					    mul r0.w, r0.w, r1.w
					    mul r1.xy, r1_abs, c3.zwzw
					    pow r2.x, r1.x, c5.w
					    mad r1.x, r1.y, -r1.y, c2.w
					    add r2.z, -r2.x, c3.y
					    cmp r2.y, r1.z, r2.z, r0.w
					    add r0.w, r1.x, -r2.z
					    cmp r2.x, r0.w, r1.x, r2.z
					    mov_sat r2.xyz, r2
					    add r1.xyz, -r0, r2
