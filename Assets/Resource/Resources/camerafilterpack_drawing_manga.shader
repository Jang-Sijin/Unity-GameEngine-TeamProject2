			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    def c3, -0.00390625, 0.00390625, 0, -1
					    def c4, 0.159154937, 0.5, 6.28318548, -3.14159274
					    def c5, 0.25, 0.5, 0.300000012, 0.0399999991
					    def c6, 0.300000012, 0.589999974, 0.109999999, 0.25
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    add r0, c3.zyyy, v0.xyxy
					    texld r1, r0, s0
					    texld r0, r0.zwzw, s0
					    dp4 r0.x, r0, c6
					    dp4 r0.y, r1, c6
					    add r1, c3.xzxy, v0.xyxy
					    texld r2, r1.zwzw, s0
					    texld r1, r1, s0
					    dp4 r0.z, r1, c6
					    dp4 r0.w, r2, c6
					    ...
					    mul r0.z, r0.z, r0.z
					    mad r1.x, r0.w, r0.z, r0.y
					    mul r1.y, r0.z, r0.w
					    mad r0.z, r0.w, -r0.z, c5.z
					    cmp r0.z, r0.z, r1.y, r1.x
					    mad oC0.xyz, r0.x, r0.y, r0.z
					    mov oC0.w, -c3.w
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat6.x = _DotSize * 0.125 + -0.200000018;
					    u_xlat6.x = (-u_xlat6.x) + u_xlat1.x;
					    u_xlat6.x = u_xlat6.x * 3.33333349;
					    u_xlat6.x = clamp(u_xlat6.x, 0.0, 1.0);
					    u_xlat9 = u_xlat6.x * -2.0 + 3.0;
					    u_xlat6.x = u_xlat6.x * u_xlat6.x;
					    u_xlat1.x = u_xlat9 * u_xlat6.x + u_xlat3.x;
					    u_xlat6.x = u_xlat6.x * u_xlat9;
					    u_xlatb9 = 0.300000012<u_xlat6.x;
					    u_xlat6.x = (u_xlatb9) ? u_xlat1.x : u_xlat6.x;
					    SV_Target0.xyz = u_xlat0.xxx * u_xlat3.xxx + u_xlat6.xxx;
					    SV_Target0.w = 1.0;
					    return;
					}"
				}
