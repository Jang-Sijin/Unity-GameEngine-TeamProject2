			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c2, 0.212599993, 0.715200007, 0.0722000003, 1.01999998
					    def c3, -0.349999994, 0, 0.0599999987, 0
					    def c4, -2, 1, 1.01999998, -1
					    def c5, 1.70000005, 25, 100, 0
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    texld r0, v0, s0
					    dp3 r0.w, r0, c2
