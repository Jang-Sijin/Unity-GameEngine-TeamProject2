			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c2, 1.29999995, -1.70000005, 0.100000001, 1.70000005
					    def c3, 0.212599993, 0.715200007, 0.0722000003, 0.430000007
					    def c4, -2, 1, 1.70000005, 0
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    texld r0, v0, s0
					    dp3 r0.w, r0, c3
					    mad r1.x, r0.w, c4.x, c4.y
					    mad r0.w, c0.x, r1.x, r0.w
					    add r1.x, -r0.w, c3.w
					    mad_sat r2.xz, r0.w, c2.xyyw, c2.zyww
					    mul r0.w, r1_abs.x, c4.z
					    mul_sat r2.y, r0.w, r0.w
					    add r1.xyz, -r0, r2
