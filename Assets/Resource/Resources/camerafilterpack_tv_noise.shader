			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c1, 100, 12.9898005, 78.2330017, 0
					    def c2, 0.159154937, 0.5, 6.28318548, -3.14159274
					    def c3, 43758.5469, 0.300000012, 0, 1
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    mov r0.x, c1.x
					    mul r0.x, r0.x, c0.x
					    mul r0.xy, r0.x, v0
					    dp2add r0.x, r0, c1.yzzw, c1.w
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = (-u_xlat1) + vec4(0.300000012, 0.0, 0.300000012, 1.0);
