			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = vec4(vec4(_Value, _Value, _Value, _Value)) * vec4(0.150000006, 0.300000012, 0.450000018, 0.600000024) + vec4(1.0, 1.0, 1.0, 1.0);
					    ...
					    u_xlat1.xyz = vec3(vec3(_Value, _Value, _Value)) * vec3(0.75, 0.900000036, 1.05000007) + vec3(1.0, 1.0, 1.0);
					    u_xlat3 = u_xlat2.xyxy * u_xlat1.xxyy + vec4(_Value2, _Value3, _Value2, _Value3);
