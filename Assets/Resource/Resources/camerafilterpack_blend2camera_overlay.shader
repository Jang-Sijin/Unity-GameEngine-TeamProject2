			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    add r2.xyz, -r3, c3.x
					    add r2.xyz, r2, r2
					    mad r1.xyz, r2, -r1, c3.x
					    add r2.xyz, r0, c3.y
					    dp2add r0.x, r0.x, r3.x, c3.z
					    cmp r4.x, r2.x, r1.x, r0.x
					    dp2add r0.x, r0.y, r3.y, c3.z
					    dp2add r0.y, r0.z, r3.z, c3.z
					    cmp r4.yz, r2, r1, r0.xxyw
					    add r0.xyz, -r3, r4
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = vec3(u_xlat15) * u_xlat0.xyz + u_xlat1.xyz;
