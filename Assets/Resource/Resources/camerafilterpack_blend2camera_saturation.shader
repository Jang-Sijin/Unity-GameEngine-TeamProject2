			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    add r1.x, -r0.z, r0.y
					    mad r2, r0.yzyy, c6.xxyy, c6.yyyz
					    mad r4, r2.yxyy, c5.xxyy, c5.yyzw
					    cmp r1, r1.x, r2.xywz, r4.xywz
					    add r2.x, r0.x, -r1.x
					    mov r0.yzw, r1.xywx
					    mov r1.xyw, r0.wyzx
					    cmp r0, r2.x, r0, r1
					    ...
					    add r0.yzw, r0_abs.y, c4.xxyz
					    frc r0.yzw, r0
					    mad r0.yzw, r0, c3.x, c3.z
					    add_sat r0.yzw, r0_abs, -c6.x
					    add r1.x, -r3.z, r3.y
					    cmp r1.yz, r1.x, r3.xzyw, r3
					    add r1.w, -r1.z, r3.x
					    mov r1.x, r3.x
					    cmp r1.xyz, r1.w, r1, r1.zyxw
					    min r2.x, r1.y, r1.z
					    add r1.y, r1.x, -r2.x
					    add r1.x, r1.x, c6.w
					    rcp r1.x, r1.x
					    mul r1.x, r1.x, r1.y
					    lrp r2.xyz, r1.x, r0.yzww, c6.x
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xyw = vec3(u_xlat17) * u_xlat2.yzx + u_xlat3.yzx;
					    u_xlat2.xyz = vec3(vec3(_Value2, _Value2, _Value2)) * u_xlat2.xyz + u_xlat3.xyz;
