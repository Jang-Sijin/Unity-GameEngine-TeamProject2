			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    def c4, 0.300000012, 0.589999974, 0.109999999, 0.25
					    def c5, -0.00390625, 0.00390625, 0, -1
					    ...
					    texld r1, v0, s0
					    mad r0.yzw, r1.xxyz, -c2.x, -r0.y
					    mov r2.xy, c1
					    mad r1.z, c0.x, r2.x, r2.y
					    mul_sat r1.z, r1.z, c1.z
					    mad r1.w, r1.z, c2.x, c2.y
					    mul r1.z, r1.z, r1.z
					    mad r1.xyz, r1.w, r1.z, r1.xyyw
					    add r0.yzw, r0, r1.xxzz
					    add r1.w, -r1.x, c6.z
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat7 = _DotSize * 0.125 + -0.200000018;
					    u_xlat7 = u_xlat7 * -3.33333349;
					    u_xlat7 = clamp(u_xlat7, 0.0, 1.0);
					    u_xlat10 = u_xlat7 * -2.0 + 3.0;
					    u_xlat7 = u_xlat7 * u_xlat7;
					    u_xlat1.xyz = vec3(u_xlat10) * vec3(u_xlat7) + u_xlat1.xyy;
					    u_xlat3.xyz = u_xlat3.xyz + u_xlat1.xzz;
					    u_xlatb10 = 0.300000012<u_xlat1.x;
