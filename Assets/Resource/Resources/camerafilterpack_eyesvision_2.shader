			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    def c8, 43758.5469, 23, -0.0240000002, 0.0160000008
					    def c9, 0.800000012, 0.075000003, 0.0500000007, 0.0199999996
					    def c10, 0.5, 1, 0.0625, 0.0795774683
					    def c11, -1.66666663, -2, 3, -0.400000006
					    def c12, 1.20000005, 0.600000024, 4.99999952, 0
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    dcl_2d s1
					    mov r0.x, c0.x
					    ...
					    mul r0.z, r2.y, c8.x
					    frc r1.x, r0.z
					    mad r0.zw, r1.xyxy, c8, v0.xyxy
					    mad r0.zw, r0, c9.x, c9.xyyz
					    add r1.xy, c6.y, -v0
					    ...
					    sincos r3.x, r1.x
					    add r2.y, r1.y, r3.x
					    mad r0.zw, r2.xyxy, c9.w, r0
					    texld r1, r0.zwzw, s1
					    mad r0.zw, r0, -c12.x, c12.y
					    dp2add r0.z, r0.zwzw, r0.zwzw, c6.x
					    rsq r0.z, r0.z
					    rcp r0.z, r0.z
					    add r0.z, r0.z, c11.w
					    mul_sat r0.z, r0.z, c12.z
					    mad r2.xy, r1, c10.z, v0
					    add r0.w, -r2.y, c7.y
					    texld r2, r2, s0
					    ...
					    mad r0.y, r0.z, c11.y, c11.z
					    mul r0.z, r0.z, r0.z
					    mad r0.x, r0.y, r0.z, r0.x
					    mul r0.y, r0.x, c4.x
					    mad r0.yzw, r0.y, -r2.xxyz, r2.xxyz
					    add r0.xyz, -r0.x, r0.yzww
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.xy = (-u_xlat3.xy) * vec2(1.20000005, 1.20000005) + vec2(0.600000024, 0.600000024);
					    u_xlat3.x = dot(u_xlat3.xy, u_xlat3.xy);
					    u_xlat3.x = sqrt(u_xlat3.x);
					    u_xlat0.y = u_xlat3.x + -0.400000006;
					    u_xlat6.xy = u_xlat1.xy * vec2(0.0625, 0.0625) + vs_TEXCOORD0.xy;
					    u_xlat10 = (-u_xlat6.y) + 0.5;
					    u_xlat2 = texture(_MainTex, u_xlat6.xy);
					    u_xlat6.x = dot(vec2(u_xlat10), vec2(u_xlat10));
					    u_xlat6.x = sqrt(u_xlat6.x);
					    u_xlat9 = _TimeX * 0.5;
					    u_xlat9 = sin(u_xlat9);
					    u_xlat9 = u_xlat9 * u_xlat9;
					    u_xlat0.x = (-u_xlat9) * u_xlat0.x + u_xlat0.x;
					    u_xlat0.x = (-u_xlat0.x) + u_xlat6.x;
					    u_xlat0.xy = u_xlat0.xy * vec2(-1.66666663, 4.99999952);
					    u_xlat0.xy = clamp(u_xlat0.xy, 0.0, 1.0);
					    u_xlat6.x = u_xlat0.x * -2.0 + 3.0;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat0.x = (-u_xlat6.x) * u_xlat0.x + 1.0;
					    u_xlat6.x = u_xlat0.y * -2.0 + 3.0;
					    u_xlat3.x = u_xlat0.y * u_xlat0.y;
					    u_xlat0.x = u_xlat6.x * u_xlat3.x + u_xlat0.x;
					    u_xlat3.x = u_xlat0.x * _Value4;
					    u_xlat3.xyz = u_xlat3.xxx * (-u_xlat2.xyz) + u_xlat2.xyz;
