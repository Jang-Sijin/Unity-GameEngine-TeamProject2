			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c3, 1, 0.300000012, 0.589999974, 0.109999999
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    dcl_2d s1
					    mov r0.x, c3.x
					    ...
					    add r0.xyz, r0.w, r0
					    add r0.w, -r0.y, r0.x
					    cmp r1.yz, r0.w, r0.xyxw, r0.xxyw
					    max r2.x, r1.z, r0.z
					    min r2.y, r0.z, r1.y
					    add r0.w, -r1.x, r2.x
					    add r1.y, -r2.x, c3.x
					    rcp r0.w, r0.w
					    add r2.xzw, -r1.x, r0.xyyz
					    add r1.z, -r1.x, c3.x
					    mul r4.xyz, r1.z, r2.xzww
					    mul r2.xzw, r1.x, r2
					    mad r4.xyz, r4, r0.w, r1.x
					    cmp r0.xyz, r1.y, r0, r4
					    add r0.w, r1.x, -r2.y
					    rcp r0.w, r0.w
					    mad r1.xyz, r2.xzww, r0.w, r1.x
					    cmp r0.xyz, r2.y, r0, r1
					    add r0.xyz, -r3, r0
