			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    def c11, 0.95492965, 0.5, 6.28318548, -3.14159274
					    def c12, 0.0416666418, 0.200000003, 10, 0.300000012
					    def c13, 0.400000006, 0.699999988, 0, 0
					    def c14, 2.26541138, 2.58372116, 0.5, 0.333333343
					    defi i0, 3, 0, 0, 0
					    dcl_texcoord v0.xy
					    dcl_2d s0
					    mov r0.x, -c3.x
					    ...
					    rep i0
					      ...
					      frc r2.xy, r2
					      mad r2.xy, r2, c11.z, c11.w
					      mul r2.xy, r2, r2
					      mad r2.zw, r2.xyxy, c10.z, c10.w
					      mad r2.zw, r2.xyxy, r2, c9.w
					      mad r2.zw, r2.xyxy, r2, c12.x
					      mad r2.zw, r2.xyxy, r2, -c11.y
					      mad r2.xy, r2, r2.zwzw, c7.z
					      mad r2.xy, r2, c12.y, r0
					      mul r2.zw, r2_abs.xyxy, c12.z
					      frc r3.xy, r2.zwzw
					      add r3.zw, r3.xyxy, -c11.y
					      ...
					      rep i0
					        ...
					        rep i0
					          ...
					          frc r4.yz, r4
					          mad r4.yz, r4, c11.z, c11.w
					          sincos r5.x, r4.y
					          sincos r6.x, r4.z
					          add r4.y, r5.x, r6.x
					          mad r4.yz, r4.y, c12.w, r3.xzww
					    ...
					    mad r0.xy, r0.x, c14.w, v0
					    texld r0, r0, s0
					    mov oC0.xyz, r0
					    mov oC0.w, c7.z
					
					// approximately 159 instruction slots used (1 texture, 158 arithmetic)"
				}
				SubProgram "d3d11 " {
					"ps_4_0
					...
					void main()
					{
					    ...
					    u_xlat15 = (-u_xlat1) * _Value + u_xlat15;
					    u_xlat1 = float(0.0);
					    for(int u_xlati_loop_1 = int(3) ; u_xlati_loop_1<6 ; u_xlati_loop_1++)
					    {
					        ...
					        u_xlat1 = u_xlat16 * u_xlat2.x + u_xlat1;
					    }
					    u_xlat0.xyz = vec3(u_xlat1) * _Value2.xyz;
					    u_xlat0.xy = vec2(u_xlat6) * u_xlat0.xy;
					    u_xlat0.x = u_xlat0.y + u_xlat0.x;
					    u_xlat0.x = u_xlat0.z * u_xlat6 + u_xlat0.x;
					    u_xlat0.xy = u_xlat0.xx * vec2(0.333333343, 0.333333343) + vs_TEXCOORD0.xy;
