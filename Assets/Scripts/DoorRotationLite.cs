...
public class DoorRotationLite : MonoBehaviour
{
    ...
    public float TimesNoAvailable = 1.5F;
    [HideInInspector]
    ...
    // 초기(initial), 최종(final) 회전 값 정의(define)
    ...
    void Start()
    {
        ...
        // Create a (placeholder/temporary) object of the hinge (position/rotation)
    ...
    public IEnumerator Move()
    {
        ...
        if (TimesRotated < TimesMoveable || TimesMoveable == 0)
        {
            ...
            while (TimeProgression <= TimesNoAvailable)
            {
